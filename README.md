# 📊 Telecom Client Churn Prediction: MLOps Framework
Este repositorio contiene un framework integral de MLOps para predecir la salida de clientes pospago (churn) en una empresa de telecomunicaciones. El proyecto utiliza Databricks Asset Bundles (DABs) para garantizar un ciclo de vida de desarrollo de software (SDLC) robusto, facilitando la transición de experimentos en notebooks a pipelines de producción.

## 🎯 Objetivo del Business Case
La industria de las telecomunicaciones enfrenta una alta competitividad. La pérdida de contratos de clientes no solo impacta la venta actual, sino que dichas pérdidas generalmente tardan mucho tiempo en recuperarse, ya que generalmente son planes de pago a meses o incluso años que comprometen a los clientes.

## Propuesta de valor:

Identificación Proactiva: Detectar patrones de abandono antes de que ocurran.

Intervención Basada en Datos: Segmentar clientes en riesgo para aplicar programas de retención personalizados.
...
**Ingesta & Feature Engineering:** Procesamiento de datos de clientes (antigüedad, satisfacción, salario, demográficos) mediante Spark SQL.
...
**Reducción de Atrición:** Objetivo de disminuir la tasa de abandono en un 10% anual.
